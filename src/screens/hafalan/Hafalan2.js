...
class AudioExample extends Component {
  state = {
    ...
    bearer: AsyncStorage.getItem('@storage_bearer'),
  };
  ...
  send = async () => {
    ...
    AudioRecorder.onFinished = async data => {
      let fd = new FormData();
      const file = 'file://' + data.audioFileURL;
      await fd.append('file', file);
      await fd.append('user_id', 'dca7d49e-1ac4-4450-b228-1391d11877ba');
      await fd.append('surat', 'test');
      await fd.append('juz', 'test');
      await fd.append('ayat', '12');
